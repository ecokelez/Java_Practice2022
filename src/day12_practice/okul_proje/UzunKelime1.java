package day12_practice.okul_proje;

import java.util.Scanner;

public class UzunKelime1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("theLongestWorld(str) : " + theLongestWorld(str));


    }

    private static String theLongestWorld(String str) {  // en uzun leimeyi istiyor

        String[]arr=str.split(" "); // "" isareti icerisnde bir bosluk bırakılırsa bosluktan boler verilen ifadeyi,
                                        // "" bosluk bırakmazsak tum karakterlerin arasından boler
        int max=0;
        String longestWorld="";
