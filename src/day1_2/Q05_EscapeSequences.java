...
public class Q05_EscapeSequences {
    ...
    Örneğin, sekme, satır başı ve geri alma gibi karakterleri bir çıkış akışına koymak için
    kaçış dizilerini kullanabilirsiniz.
    ...
    public static void main(String[] args) {
        //  Soru-1 :   konsola   "Hello ", "World \ //"   seklinde yazdiriniz ---> !!! Interview Sorusu !!!
